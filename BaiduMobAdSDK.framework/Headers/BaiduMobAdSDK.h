...
//! Project version number for BaiduMobAdSDK.
FOUNDATION_EXPORT double BaiduMobAdSDKVersionNumber;

//! Project version string for BaiduMobAdSDK.
FOUNDATION_EXPORT const unsigned char BaiduMobAdSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <BaiduMobAdSDK/PublicHeader.h>
...
#import <BaiduMobAdSDK/BaiduMobAdNativeAdEntryObject.h>
